...
export default function Lookup() {
  ...
  const scheduleData = [
    ...
    },
    {
      ...
      maMH: 'Khoa Nhà nước và pháp luật',
      thuHoc: 'T2, T4, T6',
      soNgay: 23,
      ngayThi: '24/10/2025',
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-[1600px] mx-auto">
        {/* Header */}
        <h1 className="text-2xl text-gray-600 mb-6">Lịch Học - Môn học trong Tháng</h1>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <option value="TC240">Lịch sử đảng cộng sản Việt Nam</option>
                <option value="H946">Xây dựng đảng</option>
                <option value="H949">Kiến trúc bổ trợ</option>
              </select>
            </div>
              ...
              <tbody>
                {scheduleData.slice((currentPage - 1) * pageSize, currentPage * pageSize).map((row, index) => (
                  <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 border-r border-gray-200">{row.maMH}</td>
