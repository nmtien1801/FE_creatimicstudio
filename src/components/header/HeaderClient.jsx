      ...
      <div className="w-full px-4 py-4 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:block">
            <h1 className="text-2xl font-black bg-white bg-clip-text text-transparent">
              CREATIMICSTUDIO
            </h1>
        ...
        {/* SEARCH + MEGA MENU */}
        <div className="flex-1 max-w-2xl mx-4 hidden md:flex items-stretch rounded-2xl shadow-lg border-2 border-gray-100 bg-white relative">
          <input
            type="text"
            placeholder="Nhập sản phẩm tìm kiếm nhanh hơn..."
            className="flex-1 px-6 py-3 text-gray-700 focus:outline-none bg-white rounded-l-2xl"
            value={searchQuery}
        ...
        <div className="hidden lg:flex space-x-8 text-sm text-gray-600 items-center">
          <a href="tel:0372672396" className="flex items-center gap-2 text-white transition-colors font-medium">
            <Phone className="w-4 h-4 text-white" />
            037.2672.396 - Hotline đặt hàng
          </a>
          <a href="tel:0347577034" className="flex items-center gap-2 text-white transition-colors font-medium">
            <Phone className="w-4 h-4 text-white" />
        ...
        <button
          ...
          className="relative p-3 bg-[#ed792f] text-white rounded-xl md:hidden hover:shadow-xl hover:scale-110 transition-all"
        >
            ...
            {menuItems.map((item) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  ...
                  ${isActive ? "text-[#ed792f]" : "text-black-300 hover:text-[#ed792f]"}`
                }
              >
